...
Research topic: **proposition-level response scope in workplace email and dialogue, with emphasis on partial replies to multi-question or multi-proposition antecedents, unanswered subquestions, approval/rejection scope, and multi-antecedent response links**
...
- paper_id `2403.16609` — Conversational Grounding: Annotation and Analysis of Grounding Acts and Grounding Units (Biswesh Mohapatra, Seemab Hassan, Laurent Romary et al.; 2024)
    html: https://arxiv.org/html/2403.16609
    abs: https://arxiv.org/abs/2403.16609
    pdf: https://arxiv.org/pdf/2403.16609
