...
Research topic: **Integrated evaluation of evidence completeness and omission for temporally evolving multi-source free-form generation, with calibrated selective prediction under non-stationary distribution shift**
...
- paper_id `2510.12839` — FaStFACT: Faster, Stronger Long-Form Factuality Evaluations in LLMs (Yingjia Wan, Haochen Tan, Xiao Zhu et al.; 2025)
    html: https://arxiv.org/html/2510.12839
    abs: https://arxiv.org/abs/2510.12839
    pdf: https://arxiv.org/pdf/2510.12839
- paper_id `2511.16198` — SemanticCite: Citation Verification with AI-Powered Full-Text Analysis and Evidence-Based Reasoning (Sebastian Haan; 2025)
    html: https://arxiv.org/html/2511.16198
    abs: https://arxiv.org/abs/2511.16198
    pdf: https://arxiv.org/pdf/2511.16198
- paper_id `2408.08067` — RAGChecker: A Fine-grained Framework for Diagnosing Retrieval-Augmented Generation (Dongyu Ru, Lin Qiu, Xiangkun Hu et al.; 2024)
    html: https://arxiv.org/html/2408.08067
    abs: https://arxiv.org/abs/2408.08067
    pdf: https://arxiv.org/pdf/2408.08067
- paper_id `2602.16537` — Optimal training-conditional regret for online conformal prediction (Jiadong Liang, Zhimei Ren, Yuxin Chen; 2026)
    html: https://arxiv.org/html/2602.16537
    abs: https://arxiv.org/abs/2602.16537
    pdf: https://arxiv.org/pdf/2602.16537
- paper_id `2602.11908` — When Should LLMs Be Less Specific? Selective Abstraction for Reliable Long-Form Text Generation (Shani Goren, Ido Galil, Ran El-Yaniv; 2026)
    html: https://arxiv.org/html/2602.11908
    abs: https://arxiv.org/abs/2602.11908
    pdf: https://arxiv.org/pdf/2602.11908
