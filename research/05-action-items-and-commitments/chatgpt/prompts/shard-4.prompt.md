...
Research topic: **action items, requests, commitments, and decisions in workplace email and chat: extracting action, owner, object, deadline, conditions, and speech act with evidence**
...
- paper_id `2106.08037` — The Possible, the Plausible, and the Desirable: Event-Based Modality Detection for Language Processing (Valentina Pyatkin, Shoval Sadde, Aynat Rubinstein et al.; 2021)
    html: https://arxiv.org/html/2106.08037
    abs: https://arxiv.org/abs/2106.08037
    pdf: https://arxiv.org/pdf/2106.08037
