...
Research topic: **empirical workplace email and chat studies on structured action and decision extraction, focusing on owner assignment, deadline-to-action binding, conditional or negated obligations, and evidence-span annotation**
...
- paper_id `2005.13084` — Learning with Weak Supervision for Email Intent Detection (Kai Shu, Subhabrata Mukherjee, Guoqing Zheng et al.; 2020)
    html: https://arxiv.org/html/2005.13084
    abs: https://arxiv.org/abs/2005.13084
    pdf: https://arxiv.org/pdf/2005.13084
...
- paper_id `1909.10094` — Deep Structured Neural Network for Event Temporal Relation Extraction (Rujun Han, I-Hung Hsu, Mu Yang et al.; 2019)
    html: https://arxiv.org/html/1909.10094
    abs: https://arxiv.org/abs/1909.10094
    pdf: https://arxiv.org/pdf/1909.10094
