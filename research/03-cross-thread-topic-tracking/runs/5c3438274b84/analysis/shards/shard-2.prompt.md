...
Research topic: **Direct enterprise communication evidence for cross-thread work-matter continuity, with emphasis on email/chat conversation linking, business-event coreference, and partial or evolving event identity in organizational workflows.**
...
- paper_id `1707.07344` — Event Coreference Resolution by Iteratively Unfolding Inter-dependencies among Events (Prafulla Kumar Choubey, Ruihong Huang; 2017)
    html: https://arxiv.org/html/1707.07344
    abs: https://arxiv.org/abs/1707.07344
    pdf: https://arxiv.org/pdf/1707.07344
