...
Papers:
- paper_id `doi-10-1016-j-procs-2026-02-155` — Surrogate Case Identifier Rules for Construction Site Hoists (Erjan Steenbergen, Rob Bemthuis, Faiza Bukhsh; 2026)
- paper_id `doi-10-1016-j-knosys-2017-09-039` — Adaptive online event detection in news streams (Linmei Hu, Bin Zhang, Lei Hou et al.; 2017)
- paper_id `doi-10-1016-j-ins-2016-03-002` — Assessing e-mail intent and tasks in e-mail messages (Maya Sappelli, Gabriella Pasi, Suzan Verberne et al.; 2016)
