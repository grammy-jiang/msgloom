...
**Status: proposal delivered 2026-09-17**, in
`msgloom-topic-definition-proposal.md`. Its four open questions are all settled
(D-11, D-12, D-13, and one design default). **The definition itself — §§1–6 —
is not yet approved** and should be read before architecture design fixes the
data model.
